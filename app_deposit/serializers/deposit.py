...
class DepositCreateSerializer(serializers.ModelSerializer):
    optixpay_component = serializers.CharField(max_length=255, write_only=True)
    ...
    def create(self, validated_data):
        ...
        #     {'customer_id': '14ejsn', 'order_id': '213enjdsfn', 'bank_name': 'bkash', 'sending_amount': 1000, 'sending_currency': 'BDT'}
        # """
        ...
        for bank in agent_bank:
            ...
            with_commission_balance = float(float(sending_amount) * float(bank_deposit_commission))/100.0 + float(sending_amount)
