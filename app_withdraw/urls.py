...
from app_withdraw.views.withdraw import WithdrawListAPIView, WithdrawCreateAPIView, \
    WithdrawDeleteAPIView, WithdrawUpdateAPIView, BankTypeForWithdrawCreateAPIView, WithdrawCreateP2PExternalAPIView, \
    MerchantWalletListAPIView, SendWithdrawDataToTheMerchantAPIView
...
urlpatterns = [
    ...
    path('withdraw-webhook/', SendWithdrawDataToTheMerchantAPIView.as_view(), name='withdraw-webhook'),
